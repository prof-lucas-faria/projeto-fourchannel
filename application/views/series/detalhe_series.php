<div id="content-sidebar-pro">
    ...
    <div id="content-sidebar-image">
        <img src="https://image.tmdb.org/t/p/original<?=$detalhes_full->detalhes->poster_path?>" alt="Movie Poster">
    </div>
    ...
    <div class="content-sidebar-section">
        <h4 class="content-sidebar-sub-header">Lançamento da primeira temporada</h4>
...
Biblioteca</Button></h4>"?>  
        ...
        <div class="movie-details-section">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                    <div class="item-listing-container-skrn">
                        <a href="#!"><img src="https://image.tmdb.org/t/p/w500<?=$criado['profile_path']?>"
                                alt="Cast"></a>
                        <div class="item-listing-text-skrn item-listing-movie-casting">
            ...
            <div class="movie-details-section">
                ...
                <div class="movie-details-section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="item-listing-container-skrn">
                                <a href="<?=base_url()?>index.php/Series/detalheSeries/<?=$series_similares['id']?>"><img
