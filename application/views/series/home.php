                ...
                <div class="progression-studios-slider-dashboard-image-background"
                    ...
                    <div class="progression-studios-slider-display-table">
                        <div class="progression-studios-slider-vertical-align">
                            ...
                            <div class="container">
                                <div class="circle-rating-pro" data-value="0.<?= round($listaInicial['vote_average'])  ?>" data-animation-start-value="0.86"
                                    data-size="70" data-thickness="6" data-fill="{
								          &quot;color&quot;: &quot;#42b740&quot;
								        }" data-empty-fill="#def6de" data-reverse="true"><span style="color:#42b740;"><?= $listaInicial['vote_average']?></span></div>
                        ...
                        <div class="item-listing-text-skrn-vertical-align">
                            ...
                            <div class="circle-rating-pro" data-value="0.<?= round($listaDePopulares['vote_average'])  ?>" data-animation-start-value="0.6"
                                data-size="32" data-thickness="3" data-fill="{
							          &quot;color&quot;: &quot;#42b740&quot;
							        }" data-empty-fill="#ffe1e1" data-reverse="true"><span style="color:#ff4141;"><?= $listaDePopulares['vote_average']?></span></div>
