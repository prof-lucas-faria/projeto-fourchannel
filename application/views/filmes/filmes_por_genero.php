...
<div class="flexslider progression-studios-dashboard-slider progression-studios-full-height-slider">
    ...
    <div class="dashboard-container">
        ...
        <h4 class="heading-extra-margin-bottom">Filmes Por Genero </h4>
        <div class="row">
        <?php foreach($listaDeFilmesPorGenero->porgenero->results as $listar){?>
            <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                <div class="item-listing-container-skrn">
                    <a href="<?=base_url()?>index.php/Filmes/detalheFilmes/<?=  $listar['id']?>"><img src="https://image.tmdb.org/t/p/original<?= $listar['poster_path']?>"
                            alt="Listing"></a>
                    <div class="item-listing-text-skrn">
                        <div class="item-listing-text-skrn-vertical-align">
                            <h6><a href="<?=base_url()?>index.php/Filmes/detalheFilmes/<?= $listar['id']?>"><?= $listar['title']?></a></h6>
