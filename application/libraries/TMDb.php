...
class TMDb
{
     ...
     * @return void
     */
    public function __construct($apikey = "6dcde26140cb5c580e23778e7ab1867a", $config = false, $scheme = TMDb::API_SCHEME)
    {
        // Load config file
     ...
     * @return TMDb result array
     */
    public function getMovie($id, $lang = 'pt-BR')
    {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getMovieTrailers($id, $lang = 'pt-BR')
    {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getMovieImages($id, $lang = 'pt-BR')
    {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getSimilarMovies($id, $page = 1, $lang = 'pt-BR')
    {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
     ...
     * @return TMDb result array
     */
    public function getUpcomingMovies($page = 1, $lang = 'pt-BR')
    {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
     ...
     * @return TMDb result array
     */
    public function getPopularMovies($page = 1, $lang = 'pt-BR')
    {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
     ...
     * @return TMDb result array
     */
    public function getTopRatedMovies($page = 1, $lang = 'pt-BR')
    {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
    ...
    public function getMoviesForGenre( $genreId, $page = 1)
    {
        $param = array(
            'language' => 'pt-BR',
     ...
     * @return TMDb result array
     */
    public function getPersonCredits($id, $lang = 'pt-BR')
    {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getMoviesByCompany($id, $page = 1, $lang = 'pt-BR')
    {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
     ...
     * @return TMDb result array
     */
    public function getGenres($lang = 'pt-BR')
    {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getMoviesByGenre($id, $page = 1, $lang = 'pt-BR')
    {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
     ...
     * @return TMDb result array
     */
    public function getAccountFavoriteMovies($account_id, $session_id = null, $page = 1, $lang = 'pt-BR')
    {
        $session_id = ($session_id === null) ? $this->_session_id : $session_id;
        $params = array(
            'page' => (int) $page,
     ...
     * @return TMDb result array
     */
    public function getAccountRatedMovies($account_id, $session_id = null, $page = 1, $lang = 'pt-BR')
    {
        $session_id = ($session_id === null) ? $this->_session_id : $session_id;
        $params = array(
            'page' => (int) $page,
     ...
     * @return TMDb result array
     */
    public function getAccountWatchlistMovies($account_id, $session_id = null, $page = 1, $lang = 'pt-BR')
    {
        $session_id = ($session_id === null) ? $this->_session_id : $session_id;
        $params = array(
            'page' => (int) $page,
